...
# Using the new data to test how well the model predicts. 
 
modelr::rmse(model1, TestData)
...
BernieData=NewData[NewData$ID=="Bernie",]
...
#Predicting how Bernie should do in MLU from the TD data
predict(TdModel, BernieData, allow.new.levels=TRUE)

#Difference from expected values in MLU to actual values
BernieData$CHI_MLU - predict(TdModel, BernieData, allow.new.levels=TRUE)

#Plotting the differences
plot(BernieData$CHI_MLU - predict(TdModel, BernieData, allow.new.levels=TRUE))
```

[HERE GOES YOUR ANSWER]

Bernie generally lies above in MLU, than what he is expected to, according to the model. In the first visit he have a MLU score of 0.38 above the expected score of 1.604. In the second visit he have a MLU score a bit below the expected score, but in the rest of the visits he has a higher MLU score than expected. In the last visit (visit 6) he scores 0.222 above what is expected. 
